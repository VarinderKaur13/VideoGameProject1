package testCases;
	...
	@Test(priority=1)
		...
		public void test_getVideoGame()
		{
			...
			.when()
				.get(URI+"/videogames"+"/110")   //http://localhost:8080/app/videogames/110
			.then()
				.statusCode(200)
				.log().body()
				.body("videoGame.id",equalTo("110"))
		...
		public void test_UpdateVideoGame()
		{
				...
				given()
					...
					.body(data)
				.when()
					.put(URI+"/videogames"+"/110") //http://localhost:8080/app/videogames/110
				.then()
					.statusCode(200)
					.log().body()
					.body("videoGame.id",equalTo("110"))
